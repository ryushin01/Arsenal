    ...
    <>
      ...
      >
        ...
        <section className="py-2 px-4">
          ...
          <Link href="/zoomable/pdf-viewer">
            <span className="block w-full h-[100px] relative overflow-hidden">
              <span className="block w-full h-[100px] left-0 top-0 absolute bg-amber-300 rounded-[20px]" />
              <Image
                ...
                alt="KOS 앱을 연 스마트폰"
              />
              <span className="block w-[247px] left-[24px] top-[25px] absolute">
                <span
